...
function SettingsLayout({ active, onNavigate, title, sub, actions, children }) {
  return (
    <div style={{ maxWidth: 1180, margin: '0 auto', padding: '64px 32px 0', display: 'flex', flexDirection: 'column', gap: 28 }}>
      <Breadcrumb items={['Settings', title]} />
      <div style={{ display: 'grid', gridTemplateColumns: '248px 1fr', gap: 36, alignItems: 'start' }}>
        <SettingsRail active={active} onNavigate={onNavigate} />
